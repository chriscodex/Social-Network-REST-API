...
- Clients can receive responses of new posts published by WebSockets.
...
- ### **Delete a Post**  
Allows a user to delete their post by the post id as a path parameter. Only the user who created the post can delete it.
